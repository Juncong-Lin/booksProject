...
window.handleCategoryClick = function (categoryName) {
  ...
  if (window.subHeaderNav && window.subHeaderNav.hideAllSubmenus) {
    ...
    document
      .querySelectorAll(".sub-header-submenu.active")
      .forEach((submenu) => {
  ...
  // Check if we're on the index page
  if (
    UrlUtils.isIndexPage() &&
    window.loadSpecificCategory &&
    typeof window.loadSpecificCategory === "function"
  ) {
...
function fixPrintSparePartsSubmenuItems() {
  ...
  setTimeout(() => {
    ...
    const printSparePartsItems = document.querySelectorAll(
    ...
    printSparePartsItems.forEach((item) => {
      ...
      if (
        itemText.includes("Printer Parts") ||
        itemText.includes("Printer Spare Parts")
      ) {
...
window.handlePrintheadClick = function (brand) {
  ...
  if (
    UrlUtils.isIndexPage() &&
    window.loadPrintheadProducts &&
    typeof window.loadPrintheadProducts === "function"
  ) {
    // We're on index page - use existing function
...
window.handleUpgradingKitClick = function (kitType) {
  ...
  if (
    UrlUtils.isIndexPage() &&
    window.loadUpgradingKitProducts &&
    typeof window.loadUpgradingKitProducts === "function"
  ) {
...
window.handleMaterialClick = function (materialCategory) {
  ...
  if (
    UrlUtils.isIndexPage() &&
    window.loadMaterialProducts &&
    typeof window.loadMaterialProducts === "function"
  ) {
    // We're on the index page - load products directly
...
window.handleLedLcdClick = function (ledLcdCategory) {
  ...
  if (
    UrlUtils.isIndexPage() &&
    window.loadLedLcdProducts &&
    typeof window.loadLedLcdProducts === "function"
  ) {
    // We're on the index page - load products directly
...
window.handleChannelLetterClick = function (channelLetterCategory) {
  ...
  if (
    UrlUtils.isIndexPage() &&
    window.loadChannelLetterProducts &&
    typeof window.loadChannelLetterProducts === "function"
  ) {
    // We're on the index page - load products directly
...
window.handleOtherClick = function (otherCategory) {
  ...
  if (
    UrlUtils.isIndexPage() &&
    window.loadOtherProducts &&
    typeof window.loadOtherProducts === "function"
  ) {
    // We're on the index page - load products directly
