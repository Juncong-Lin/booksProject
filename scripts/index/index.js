...
function updateBreadcrumb(brand) {
  ...
  if (brand && brand !== "all") {
    ...
    if (brand === "printHeads") {
      ...
      brand === "mimaki" ||
      brand === "mutoh" ||
      brand === "roll_to_roll_style" ||
      brand === "uv_flatbed" ||
      brand === "without_cable_work"
    ) {
      ...
      if (isDetailPage) {
        breadcrumbElement.innerHTML = `
          ...
          <span class="breadcrumb-separator">&gt;</span>
          <a href="javascript:void(0)" class="breadcrumb-link" onclick="loadUpgradingKitProducts('${brand}')">${
      ...
      if (isDetailPage) {
        breadcrumbElement.innerHTML = `
          ...
          <span class="breadcrumb-separator">&gt;</span>
          <a href="javascript:void(0)" class="breadcrumb-link" onclick="loadMaterialProducts('${materialCategory}')">${
          materialCategory.charAt(0).toUpperCase() + materialCategory.slice(1)
        } Materials</a>
        `;
      } else {
        breadcrumbElement.innerHTML = `
      ...
      if (isDetailPage) {
        breadcrumbElement.innerHTML = `
          ...
          <span class="breadcrumb-separator">&gt;</span>
          <a href="javascript:void(0)" class="breadcrumb-link" onclick="loadLedLcdProducts('${ledLcdCategory}')">${
          ledLcdCategory.charAt(0).toUpperCase() + ledLcdCategory.slice(1)
        } LED & LCD</a>
        `;
      } else {
        breadcrumbElement.innerHTML = `
      ...
      if (isDetailPage) {
        breadcrumbElement.innerHTML = `
          ...
          <span class="breadcrumb-separator">&gt;</span>
          <span class="breadcrumb-current">${
            channelLetterCategory.charAt(0).toUpperCase() +
            channelLetterCategory.slice(1)
          } Channel Letter</span>
        `;
      } else {
        breadcrumbElement.innerHTML = `
          <a href="index.html" class="breadcrumb-link" onclick="if(typeof loadAllProducts === 'function') { loadAllProducts(); return false; }">Home</a>
          <span class="breadcrumb-separator">&gt;</span>
          <a href="javascript:void(0)" class="breadcrumb-link" onclick="loadChannelLetterProducts('${channelLetterCategory}')">${
          channelLetterCategory.charAt(0).toUpperCase() +
          channelLetterCategory.slice(1)
        } Channel Letter</a>
          <span class="breadcrumb-separator">&gt;</span>
      ...
      if (isDetailPage) {
        breadcrumbElement.innerHTML = `
          ...
          <span class="breadcrumb-separator">&gt;</span>
          <span class="breadcrumb-current">${
            otherCategory.charAt(0).toUpperCase() + otherCategory.slice(1)
          } Other Products</span>
        `;
      } else {
        breadcrumbElement.innerHTML = `
          <a href="index.html" class="breadcrumb-link" onclick="if(typeof loadAllProducts === 'function') { loadAllProducts(); return false; }">Home</a>
          <span class="breadcrumb-separator">&gt;</span>
          <a href="javascript:void(0)" class="breadcrumb-link" onclick="loadOtherProducts('${otherCategory}')">${
          otherCategory.charAt(0).toUpperCase() + otherCategory.slice(1)
        } Other Products</a>
          <span class="breadcrumb-separator">&gt;</span>
      ...
      if (isDetailPage) {
        ...
        breadcrumbElement.innerHTML = `
          ...
          <span class="breadcrumb-separator">&gt;</span>
          <a href="javascript:void(0)" class="breadcrumb-link" onclick="loadPrintheadProducts('${brand}')">${
...
function highlightSelectedMenuItem(brand) {
  ...
  document
    .querySelectorAll(".department-link.selected-brand")
    .forEach((link) => {
...
document.addEventListener("DOMContentLoaded", () => {
  document.querySelectorAll(".department-link").forEach((link) => {
    link.addEventListener("click", function (e) {
      ...
      const expandableParent = link.closest(
        ".department-group, .department-subgroup"
      );
      ...
      const matchCategory =
        categoryMap[mainCategory] || categoryMap[sidebarCategory];
